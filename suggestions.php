        ...
        <div class="modal-content">
          ...
          <div class="modal-body task-modal pl-5 pr-5">
              ...
              <div class="col-md-7" style="border-right: #35b9e5 1px solid !important;">
                  ...
                  <p><i class="fa fa-map-marker" aria-hidden="true"></i> At -<em id="loc">Sakumono </em>in th
<strong id="tsk_dist"> Tema Metropolitan Assembly</strong></p>
                  <p id="due">On Date  at time </p>
